...
write.csv(gamesdf,'gamesdf.csv')

# 2.
# a)

######################################################
### Seperating the Playoffs and the Regular Season ###
######################################################

setwd('/Users/matty/Documents/BYU/STAT_RA')
gamesdf <- read_csv('gamesdf.csv')
...
write.csv(regular_season,'regular_season.csv')
write.csv(playoff_games,'playoff_games.csv')
...
setwd('/Users/matty/Documents/BYU/STAT_RA')
regular_season <- read_csv('regular_season.csv')
playoff_games <- read_csv('playoff_games.csv')
